...
import 'map_screen.dart';  // Asegúrate de importar tu nuevo componente de mapa
...
class _ReportPageState extends State<ReportPage> {
  ...
  Future<void> submitReport() async {
    if (_formKey.currentState!.validate()) {
      ...
      // Asegúrate de que las ubicaciones no sean nulas
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            TextFormField(
              decoration: InputDecoration(labelText: 'Descripción adicional'),
            ...
            MapScreen(
              onLocationSelected: (LatLng reportLocation) {
                setState(() {
                  _reportLocation = reportLocation;  // Guardar la ubicación del reporte
                });
              },
              onUserLocationObtained: (LatLng userLocation) {
                setState(() {
                  _userLocation = userLocation;  // Guardar la ubicación actual del usuario
                });
              }
            ),
